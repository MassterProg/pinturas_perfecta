...
namespace PinturasPerfecta
{
    class Conexion
    {
        public static MySqlConnection verificarBD()//Valida la conexión de la base de datos
        {
            ...
            //string cadenaconexion = "server=localhost; port=3306; user=root; password=; database=perfecta;";//En caso marque error inserter la contraseña y la base de datos tiene que ser la que se quiera usar
